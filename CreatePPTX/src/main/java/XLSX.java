...
public class XLSX {
    // CONSTANTS
    /*----------------------------------------------------------*/
    static final String FILE_SAVE_LOCATION = "D://Others//";
    static final String FILE_NAME = "Test_report.xlsx";
    /*----------------------------------------------------------*/

    public static void main(String[] args) throws IOException {
        XSSFWorkbook workbook = createXLSX ();
        try {
            FileOutputStream outputStream = new FileOutputStream(FILE_SAVE_LOCATION + FILE_NAME);
    ...
    public static XSSFChart createChart() {
        // creating workbook
        XSSFWorkbook workbook = new XSSFWorkbook();
        // creating sheet with name "Report" in workbook
        XSSFSheet sheet = workbook.createSheet("Report");
