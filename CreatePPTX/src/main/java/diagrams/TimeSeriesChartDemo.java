...
//      panel.setMouseWheelEnabled(true);
    ...
    public static void main(String[] args) throws IOException {
        TimeSeriesChartDemo demo = new TimeSeriesChartDemo("TimeSeriesChart Demo");
        //demo.pack();
        //RefineryUtilities.centerFrameOnScreen(demo);
        //demo.setVisible(true);
        ChartUtilities.saveChartAsPNG(new File("D://Others//diagram1.png"), demo.createChart(demo.createDataset()), 1500, 300);
    }
}
